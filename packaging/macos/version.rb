class Buildfab < Formula
  ...
  url "https://github.com/AlexBurnes/buildfab/releases/download/v0.16.15/buildfab_darwin_amd64.tar.gz"
  sha256 "PLACEHOLDER_SHA256"
  license "MIT"
  
  if Hardware::CPU.arm?
    url "https://github.com/AlexBurnes/buildfab/releases/download/v0.16.15/buildfab_darwin_arm64.tar.gz"
