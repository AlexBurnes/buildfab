class Buildfab < Formula
  ...
  url "https://github.com/burnes/buildfab/releases/download/v0.8.0/buildfab_macos_amd64.tar.gz"
  sha256 "PLACEHOLDER_SHA256"
  license "MIT"
  
  if Hardware::CPU.arm?
    url "https://github.com/burnes/buildfab/releases/download/v0.8.0/buildfab_macos_arm64.tar.gz"
